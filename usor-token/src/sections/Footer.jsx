...
export default function Footer() {
  ...
  return (
    <footer className="bg-[#0B0B0B] pt-20 md:pt-32 pb-12 px-6 md:px-10 border-t border-gray-900">
      <div className="max-w-7xl mx-auto">
        
        {/* MAIN FOOTER CONTENT: Horizontal on PC, Stacked on Mobile */}
        <div className="flex flex-col lg:flex-row justify-between gap-16 mb-20 md:mb-32">
          
          {/* BRAND COLUMN: Stays left on PC */}
          <div className="flex flex-col items-center lg:items-start text-center lg:text-left max-w-sm">
            <img 
              src={logo} 
              alt="U.S. Oil" 
              className="w-14 h-14 rounded-full mb-6 border border-gray-800 shadow-lg" 
            />
            <h3 className="text-white text-3xl font-bold mb-4 tracking-tighter uppercase">U.S Oil</h3>
            ...
            <div className="flex gap-3">
              <a href="#" className="w-10 h-10 bg-[#1c1c1e] rounded-lg flex items-center justify-center text-gray-400 border border-gray-800 hover:border-[#D4AF37]/40 transition-all">
        ...
        {/* BOTTOM STRIP: Single line on PC */}
        <div className="pt-10 border-t border-gray-900 flex flex-col md:flex-row justify-between items-center gap-8 md:gap-0">
          <p className="text-gray-600 text-sm font-medium order-2 md:order-1">
            © 2026 U.S Oil . All rights reserved.
          </p>
          
          <div className="flex gap-10 md:gap-16 order-1 md:order-2">
